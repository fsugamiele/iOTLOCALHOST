        ...
        watch:  {
            config: {
                ...
                handler(newVal, oldVal) {
                    const newTopic = newVal.userId + '/' + newVal.selectedDevice.dId + '/' + newVal.variable;
                    const oldTopic = oldVal ? (oldVal.userId + '/' + oldVal.selectedDevice.dId + '/' + oldVal.variable) : null;
                    const topicChanged = newTopic !== oldTopic;
